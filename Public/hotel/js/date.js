    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                var html = "<div class='headerWrapper'><div class='headerTip'><a class='back'></a><a class='favourite'></a><span  style='text-align: center;display:block;font-size:18px;height: 44px;'>请选择入住离店日期</span></div><div class='comfire'>完成</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
                ...
                $(me.sections).find('.headerWrapper').css({
                  ...
                  /*  "background":"#fff",*/
                    "position": "fixed",
                    "z-index":"9999",
                    "background": "rgb(228, 47, 70) none repeat scroll 0% 0%",
                        ...
                        if ($(this).text() == '离店') {
                            ...
                            $(me.sections).find('.tbody .rz').each(function(index, element) {
                                if ($(this).text() == '入住') {
                                    ...
                                    // var arr1=startDayArrays.slice(0,4);
                                    ...
                                    //添加入住到input
                                    var start_date = startDayYear + '-' + startDayMonth + '-' + day;
                                    $('#startDate').val(start_date);
                                    $.cookie("start_date" , start_date, {path: '/api'});
                                }
                                if ($(this).text() == '离店') {
                                    ...
                                    //添加入住到input
                                    var end_date = endDayYear + '-' + endDayMonth + '-' + day;
                                    $('#endDate').val(end_date);
                                    $.cookie("end_date" , end_date, {path: '/api'});
                                   ...
                                   // 如果入住等于离店
                                    ...
                                    var $product = $('#order_form input[name=product_id]');
                                    if(!!$product) {
...
//                                          dataType: 'json',
//                                          data: {
//                                              'action':'product_price_info',
//                                              'product_id': product_id
//                                          },
//                                          success: function(data) {
//                                              if(data.days_price) {
//                                                  $('#order_form input[name=days_price]').val(data.days_price);
//                                                  $('#order_form input[name=price]').val(parseInt(data.avg_price));
//                                                  if(data.days > 1) {
//                                                      $('.order_product .price span:first').html('均￥' + parseInt(data.avg_price));
//                                                  } else {
//                                                      $('.order_product .price span:first').html('￥' + parseInt(data.avg_price));
//                                                  }
//
//                                                  //alert(parseInt(data.avg_price));
//                                              }
//                                          }
//                                      });
                                   }
